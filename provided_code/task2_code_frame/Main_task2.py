...
# • the Segmenter (segmentation.py)
# • the Detector (detection.py)
# • the TimeSeriesFilter (in trace_filter.py) [optional, currently it just returns the input]
...
def main():
    ...
    det = Detector()
    tra = BoxTracer(minLenTraces=10, iouThreshold=0.1, distTolerance=5)
